...
export type Smartphone3DebugPartKey = keyof typeof MESH_SEMANTIC;
...
function Smartphone3Impl({
  ...
  const c = colors ?? SMARTPHONE3_THEMES[SMARTPHONE3_DEFAULT_THEME];
  ...
  const placeholderImageUrl = getPlaceholderImageUrl("smartphone3");
...
export const Smartphone3 = React.memo(Smartphone3Impl);
